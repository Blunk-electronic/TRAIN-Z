...
;
;    MarioBlunk@arcor.de
;    or visit http://www.train-z.de for more contact data
;
;    history of changes:
;    Version 9.3 : - support of W29C020 FLASH EEPROM made by WINBOND
;    Version 9.5 : - support of W29C020 FLASH EEPROM made by WINBOND
;                  - improved serial communication, frequent turning on/off of RTS removed
;                    as confuses some serial controllers like Timedia Technology Co Ltd PCI2S550 (Dual 16550 UART) (rev 01)
;                  - checksum F1h
...
;used for backup in function "register dump":	;v93
bak_af		equ	01100h
bak_bc		equ	01102h
bak_de		equ	01104h
bak_hl		equ	01106h
...
;-------DOWNLOAD begin--------------------------------------------------------------------
DWNLD:	ld	C,0Bh		;defines timeout	
...
REC_BLOCK:
	...
	ei
	;call	A_RTS_ON	; rm V95/96
	halt			;await first rx char
	;call	A_RTS_OFF	; rm V95/96   
...
Welcome:
	DEFB	0Ch	;CLS
	DEFM	'TRAIN-Z V9.5 ready' ;sys version
	DEFB	0
